...
const About = () => {
  ...
  const download = (e) => {
    ...
    Axios({
      ...
      FileDownload(res.data, "Resume coming soon.png");
    });
  };
    ...
    <>
      <div className="container about-page">
        <div className="text-zone">
          ...
          <p>
            If I need to define myself in one sentence, I would describe myself
            as innovative, creative, adaptable to change, a fast learner, and
